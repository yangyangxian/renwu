...
CREATE TYPE "public"."permission_action" AS ENUM('view_task', 'create_task', 'edit_task', 'delete_task', 'view_project', 'edit_project', 'invite_member', 'update_member');--> statement-breakpoint
...
ALTER TABLE "project_members" ADD CONSTRAINT "project_members_role_id_roles_id_fk" FOREIGN KEY ("role_id") REFERENCES "public"."roles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
