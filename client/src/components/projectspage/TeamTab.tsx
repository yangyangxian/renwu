...
import { UpcomingDeadlinesCard } from '@/components/projectspage/overviewTab/UpcomingDeadlinesCard';
import { useTaskStore } from '@/stores/useTaskStore';
import { PROJECT_TEAM_LAYOUT_CLASS, PROJECT_TEAM_PRIMARY_COLUMN_CLASS } from './projectDetailLayout';
...
export function ProjectTeamTab({ project }: ProjectTeamTabProps) {
  ...
  return (
    <div className={PROJECT_TEAM_LAYOUT_CLASS}>
      <div className={PROJECT_TEAM_PRIMARY_COLUMN_CLASS}>
        <Card className="flex flex-col px-5 py-4 shadow-none">
      ...
      <UpcomingDeadlinesCard tasks={tasks} className="shadow-none p-4 h-fit" />
