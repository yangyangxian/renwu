...
export function getDialogViewportClassName(className?: string) {
  return cn(
...
export function getDialogContentClassName(className?: string) {
  return cn(
...
function DialogContent({
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      <DialogOverlay />
      <div className={getDialogViewportClassName()}>
        <DialogPrimitive.Content
          data-slot="dialog-content"
          className={getDialogContentClassName(className)}
          {...props}
        >
          {children}
          {showCloseButton && (
