...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full w-full mx-3">
      {/* Sidebar with icon and text */}
      {isAuthenticated && (
        <aside>
          <Card className="w-48 h-[calc(100vh-6rem)] p-3 flex flex-col items-center gap-2 overflow-y-auto my-3">
      ...
      <section className="flex items-start justify-start w-full ml-3">
